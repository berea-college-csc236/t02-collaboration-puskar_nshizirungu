/*  T02: Collaboration Teamwork
    ...
    TODO: <DieuMerci Nshizirungu> -- to be added by student 2

    Edits made by: Puskar 
    TODO: <Puskar Chapagain> -- to be added by student 1
...
int main() {
    ...
    for (int i = 0; i < ducknum; i++) { 
        ...
        cout << "               ( .___> /" << endl; // student 3(2) may change this line
        ...
        cout << "              <(oooo )___-" << endl; // student 3(1) may change this line and add additional lines between this line and immediately below
